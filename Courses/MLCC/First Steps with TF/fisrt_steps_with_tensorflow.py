...
if __name__ == '__main__':
    ...
    ### Build model: use LinearRegressor
    ...
    predictions = linear_regressor.predict(input_fn=prediction_input_fn) # return type: generator
    ...
    # in terms of overall summary statistics.
    print("=" * 100)
